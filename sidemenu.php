    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-2">PASWA <sup>2022</sup></div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-info py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="tamu.php">Data Tamu</a>
                        <a class="collapse-item" href="perlengkapan.php">Data Perlengkapan</a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="peserta_kelompok.php">
                    ...
                    <span>Data Peserta - Kelompok</span></a>
            </li>           
